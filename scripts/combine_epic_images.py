#!/usr/bin/env python3
"""Combine EPIC images and exposure maps, optionally masking source trails.

The masked image is intended for presentation and morphology work in the comet
frame. Quantitative extraction should still be reviewed against the event-list
products and contamination policy.
"""
...
def main() -> int:
    ...
    out_summary = {
        ...
        "finite_exposure_fraction": float(np.mean(np.isfinite(exp_sum) & (exp_sum > 0.0))),
    }
