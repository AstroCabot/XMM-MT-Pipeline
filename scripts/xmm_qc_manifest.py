#!/usr/bin/env python3
"""Generate the QC stage manifest and HTML index.

Subcommands:
    manifest -- scan pipeline outputs and write 00_manifest.png
    index    -- collect all QC PNGs into STAGE_QC.md / .html
"""
...
def cmd_manifest(args: argparse.Namespace) -> int:
    ...
    detect_mosaics = [
        str(p) for p in sorted((workdir / "detect").glob("EPIC_*_mosaic.fits"))
    ]
    detect_ok = (
